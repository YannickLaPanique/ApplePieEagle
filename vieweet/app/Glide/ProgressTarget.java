...
public abstract class ProgressTarget<T, Z> extends WrappingTarget<Z> implements OkHttpProgressGlideModule.UIProgressListener {
    ...
    public ProgressTarget(Target<Z> target, Context context) {
        this(null, target, context);
    }
    public ProgressTarget(T model, Target<Z> target, Context context) {
        super(target);
        this.model = model;
    ...
    public final void setModel(T model) {
        GlideApp.with(context)
                .clear(this);// indirectly calls cleanup
        this.model = model;
    }
    /**
    ...
    @Override public void onResourceReady(@NonNull Z resource, Transition<? super Z> animation) {
        cleanup();
